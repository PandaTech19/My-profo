...
export default function Skill() {
    ...
    return (
        <div id="Skills" className="Skill">
            <div className="Skill__title-container Skill__title-container--arb">
                <h1
            ...
            <div className="Skill__info-container Skill__info-container--arb">
                <p
                    style={{ color: theme ? `${Light}` : "" }}
                    className="Skill__info Skill__info--arb">
                    على مر السنين تعلمت أنواعًا مختلفة من التقنيات ، وهنا بعض منها
                </p>
            </div>
